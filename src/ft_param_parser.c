...
/*   Updated: 2021/02/27 23:21:11 by agigi            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_resol_parser(char **s, t_all *all)
{
	...
	if ((all->conf.res_x = ft_atoi(s[1])) == -1 || all->conf.res_x > MAX_RES_X)
		all->conf.res_x = MAX_RES_X;
	if ((all->conf.res_y = ft_atoi(s[2])) == -1 || all->conf.res_y > MAX_RES_Y)
