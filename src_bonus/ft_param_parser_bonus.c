...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_param_parser_bonus.c                            :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: agigi <agigi@student.42.fr>                +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/03/06 16:42:25 by agigi             #+#    #+#             */
/*   Updated: 2021/03/06 16:42:27 by agigi            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_resol_parser(char **s, t_all *all)
{
	...
	all->conf.res_x = ft_atoi(s[1]);
	all->conf.res_y = ft_atoi(s[2]);
	ft_check_screen_size(all);
}
...
static void	ft_rgb_parser(char **str, t_all *all)
{
	...
	if (i != 3)
		...
		ft_rgb_parser_color(str, rgb, all, 0);
	ft_memclear(rgb);
}
